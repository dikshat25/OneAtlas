...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-white border-none hover:bg-primary/90 hover:-translate-y-[1px] active:translate-y-0",
        secondary:
          "bg-white border border-border text-foreground hover:bg-secondary hover:border-input",
        outline:
