      ...
      <div className="layout">
        ...
        <div className="flex overflow-x-auto pb-8 -mx-4 px-4 sm:mx-0 sm:px-0 gap-6 snap-x hide-scrollbar">
          {templates.slice(0, 5).map(template => (
            <div 
              key={template.id} 
              className="snap-start shrink-0 w-[320px] bg-white rounded-[24px] border border-border shadow-card hover:shadow-hover hover:-translate-y-[2px] transition-all overflow-hidden flex flex-col"
            >
              {/* CSS Block Thumbnail */}
              <div className="h-[180px] bg-[#F5F5EE] border-b border-border p-4 flex flex-col gap-2 relative overflow-hidden group">
                <div className="h-2 w-full bg-white rounded-[4px] mb-1 flex items-center px-2 border border-border">
                  <div className="h-1 w-8 bg-[#ECECEC] rounded-full" />
                </div>
                <div className="flex-1 flex gap-2">
                  ...
                  <div className="flex-1 h-full bg-white border border-border rounded-[6px] p-2 flex flex-col gap-1.5">
                    ...
                    <div className="h-3 w-full bg-[#111111] opacity-[0.08] rounded-[2px]" />
                    <div className="h-3 w-full bg-[#111111] opacity-[0.08] rounded-[2px]" />
                    <div className="h-3 w-full bg-[#111111] opacity-[0.08] rounded-[2px]" />
                  </div>
                </div>
                
                <div className="absolute inset-0 bg-[#F5F5EE]/50 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center cursor-pointer" onClick={() => setPreviewTemplate(template)}>
              ...
              <div className="p-5 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-3">
                  <span className="px-2.5 py-1 rounded-md text-[11px] font-bold uppercase tracking-wider bg-hover border border-border text-primary">
                    {template.category}
                  </span>
                ...
                <p className="text-[14px] text-secondary leading-relaxed mb-6 flex-1 line-clamp-2">
