      ...
      <div className="layout">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative">
          ...
          <div className="flex flex-col relative reveal visible">
            <div className="text-[13px] font-bold text-primary uppercase mb-3">Step 01</div>
            <div className="hidden md:block absolute top-[9px] left-16 right-0 h-px bg-muted" />
          ...
          <div className="flex flex-col relative reveal visible" style={{ transitionDelay: '100ms' }}>
            <div className="text-[13px] font-bold text-primary uppercase mb-3">Step 02</div>
            <div className="hidden md:block absolute top-[9px] left-16 right-0 h-px bg-muted" />
          ...
          <div className="flex flex-col relative reveal visible" style={{ transitionDelay: '200ms' }}>
            <div className="text-[13px] font-bold text-primary uppercase mb-3">Step 03</div>
